...
class SearchVideos(RequestHandler, PageHandler, ScriptHandler):
    ...
    def __init__(self, keyword, offset = 1, mode = "json", max_results = 20, searchPreferences = "EgIQAQ%3D%3D", language = "en-US", region = "US"):
        self.offset = offset
        self.mode = mode
        self.keyword = keyword
        self.max_results = max_results
        self.searchPreferences = searchPreferences # "EgIQAQ%3D%3D" = videos, "EgQQASgB" = videos w/ caption
